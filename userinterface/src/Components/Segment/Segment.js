                                ...
                                if(ele != 'features') {
                                    return(
                                        <div>
                                            ...
                                            <div key={inde} className="font-bold"><input className="font-bold text-lg py-1" type="text" value={section[ele]} onChange={event => props.changeValue(currPos, index, event.target.value, ele)} /></div>
                                        </div>
                                    )
                                }
                            }
